<div>
    <div class="row p-4 pt-5">
        ...
        <h3 class="card-title flex-grow-1"><i class="fa fa-list fa-2x"></i> Liste nature chrono</h3>
        <div class="card-tools d-flex align-items-center">
            <a href="#" class="btn btn-link text-white mr-4 d-block" wire:click="toggleShowAddNatureForm"> <i class="fas fa-plus"></i> Nouvel nature</a>
        ...
        <thead>
        <tr>
        <th style="width: 50%;">Nature chrono</th>
