<div class="row p-4 ">
    <div class="col-md-5">
        <div class="d-flex my-4 bg-gray-light p-3">
            ...
            <div style="margin-bottom: 3px;">
                <button class="btn btn-success mr-3 mt-4" wire:click.prevent="addPJ()">Ajouter</button>
            </div>   
        </div>

        <div class="card">
            <div class="card-header bg-gradient-primary d-flex align-items-center">
            <h3 class="card-title flex-grow-1"><i class="fa fa-list fa-2x"></i> Pièces jointes courrier n°{{$pjCourrierNum}}</h3>
    ...
    <div class="col-md-7 pt-5" style="margin-top: 97px;">
        @forelse ($pjAperçu as $pjAperçu)
        <iframe src="{{asset('fichier/fichier')}}/{{$pjAperçu->pjNumerise}}" height="426" style="background: gray" class="col-md-12"></iframe>
        @empty
