        ...
        <div class="card-body">
            ...
            <div class="card card-widget widget-user-2">
                ...
                <ul class="nav flex-column">
                  ...
                  <li class="nav-item">
                    <a href="#" class="nav-link"  style="color: #000">
                        Numéro <span class="float-right">{{$numeroAperçu}}</span>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="#" class="nav-link" style="color: #000">
                        Instruction <span class="float-right">{{$objetAperçu}}</span>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="#" class="nav-link"  style="color: #000">
                  ...
                  <li class="nav-item">
                    <a href="#" class="nav-link" style="color: #000">
                        Delai théorique <span class="float-right">{{$delaiTheoriqueAperçu}} jour(s)</span>
                    </a>
                  </li>
                </ul>
