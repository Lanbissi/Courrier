<div class="row p-4 pt-5">
    <div class="col-md-6">
        ...
        <div class="form-group">
            <label>Numéro</label>
            <input type="text" readonly wire:model="numeroEdit" class="form-control @error('numeroEdit')  is-invalid  @enderror">
            @error('numeroEdit')
                <span class="text-danger">{{$message}}</span>
            @enderror
        </div>
        ...
        <div class="form-group">
            <label>Nature traitement</label>
            <select class="form-control @error('envoyer')  is-invalid  @enderror" wire:model="statut">
                <option></option>
                <option value="1">Fin traitement courrier</option>
            </select>
            @error('envoyer')
               <span class="text-danger">{{$message}}</span>
            @enderror
