          ...
          <div class="card-body">
            <div class="tab-content" id="custom-tabs-one-tabContent">
              <div class="tab-pane fade active show" id="custom-tabs-one-home" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
                ...
                <iframe src="{{asset('fichier/fichier')}}/{{$fileCourriersAperçu->courrierNumerise}}" height="650" width="977" style="background: gray"></iframe>
                @empty
                <iframe src="" height="550" width="500" style="background: gray"></iframe>
                @endforelse
              </div>

              @if ($categorieSee == "Entrant")
                    ...
                    <div class="card card-widget widget-user-2">
                      ...
                      <div class="card-footer p-0">
                        <ul class="nav flex-column">
                          ...
                          <li class="nav-item">
                            <a href="#" class="nav-link" style="color: #000">
                                Destinataire <span class="float-right">{{$destinataireSee}}</span>
                            </a>
                          </li>
                          <li class="nav-item">
                            <a href="#" class="nav-link" style="color: #000">
                                Observation<span class="float-right">{{$observationSee}}</span>
                            </a>
                          </li>
                        </ul>
                      </div>
