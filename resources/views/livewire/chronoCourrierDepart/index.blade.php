<div>
    <div class="row p-4 pt-5">
        ...
        <h3 class="card-title flex-grow-1"><i class="fa fa-list fa-2x"></i> Liste des Chronos Départ</h3>
        <div class="card-tools d-flex align-items-center">
            <a href="#" class="btn btn-link text-white mr-4 d-block" wire:click="toggleShowAddChronoForm"> <i class="fas fa-plus"></i> Ajouter un chrono</a>
             ...
             @foreach ($chronos as $chrono)
                 <tr>
                    ...
                    <td class="text-center">
                            ...
                            <button class="btn btn-link" wire:click="confirmDelete('{{$chrono->nom}}', {{$chrono->id}})"><i class="fas fa-trash-alt"></i></button>
                    </td>
                 </tr>
             @endforeach
...
<script>
    window.addEventListener("showEditForm",function(e){
       Swal.fire({
            title: "Edition d'un chrono départ",
            input: 'text',
            inputValue: e.detail.chrono.nom, 
